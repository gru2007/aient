...
class BaseLLM:
    def __init__(
        ...
        api_url: str = (os.environ.get("API_URL", None) or "https://gateway.chatall.ru/v1/chat/completions"),
        ...
        self.api_url: str = BaseAPI(api_url or "https://gateway.chatall.ru/v1/chat/completions")
